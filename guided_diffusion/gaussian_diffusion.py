...
class GaussianDiffusion:
    ...
    def p_sample_loop(self,
        ...
        timesteps = list(range(self.num_timesteps - 1, 0, -2))  
        # for _ in timesteps:
        ...
        starting = True
        # pbar = tqdm(timesteps[::-1])
        pbar = tqdm(list(range(self.num_timesteps))[::-1])
        for idx in pbar:
        # for idx, actual_timestep in enumerate(pbar):
            # actual_timestep = timesteps[idx]  
            # time = torch.tensor([actual_timestep], device=device)
